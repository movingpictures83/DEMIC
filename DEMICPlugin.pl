...
@ARGV[0] = $inputfilename1;
	$sam_dir = PerlPluMA::prefix."/".$params{'SAMdir'};
	$fasta_dir = $params{'FASTA'};
        $max_thread = $params{'threads'};
}
...
my $version = '1.0.2';
	my ($estPTR_script, $RTest) = ("plugins/DEMIC/estGrowthRate$version.R", "plugins/DEMIC/testR$version.R");
